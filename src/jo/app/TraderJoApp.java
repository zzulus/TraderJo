...
public class TraderJoApp implements EWrapper {
    ...
    public void tickPrice(int tickerId, int field, double price, int canAutoExecute) {
        log.info("tickPrice: tickerId %d, field %d, price %s, canAutoExecute %d", tickerId, field, price, canAutoExecute);
    }

    @Override
    public void tickSize(int tickerId, int field, int size) {
        log.info("tickSize: tickerId %d, field %d, size %s", tickerId, field, size);
    }
    ...
    public void tickGeneric(int tickerId, int tickType, double value) {
        log.info("tickGeneric: tickerId %d, tickType %d, value %s", tickerId, tickType, value);
    }

    @Override
    public void tickString(int tickerId, int tickType, String value) {
        // log.info("tickString: tickerId %d, tickType %d, value %s", tickerId, tickType, value);
    }
    ...
    public void nextValidId(int nextOrderId) {
        log.info("nextOrderId: " + nextOrderId);
    ...
    public void updateMktDepth(int tickerId, int position, int operation, int side, double price, int size) {
        log.info("updateMktDepth tickerId=%s, position=%s, operation=%s, side=%s, price=%s, size=%s", tickerId, position,
    ...
    public void updateMktDepthL2(int tickerId, int position, String marketMaker, int operation, int side, double price,
            int size) {
        log.info("updateMktDepthL2 tickerId=%s, position=%s, operation=%s, side=%s, price=%s, size=%s", tickerId,
    ...
    public void historicalData(int reqId, String date, double open, double high, double low, double close, int volume,
        ...
        log.info("historicalData: reqId %s, date %s, open %s, high %s, low %s, close %s, volume %s, count %s, WAP %s, hasGaps %s",
    ...
    public void realtimeBar(int reqId, long time, double open, double high, double low, double close, long volume,
        ...
        log.info("realtimeBar reqId=%s, time=%s, open=%s, high=%s, low=%s, close=%s, volume=%s, wap=%s, count=%s", reqId,
    ...
    public void tickSnapshotEnd(int reqId) {
        log.info("tickSnapshotEnd %d", reqId);
    }
