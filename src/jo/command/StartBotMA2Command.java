...
public class StartBotMA2Command implements AppCommand {
    private static final Logger log = LogManager.getLogger(StartBotMA2Command.class);
    ...
    public StartBotMA2Command(Contract contract) {
